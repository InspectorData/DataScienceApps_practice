...
* ** Datasource:** [pro-football-reference.com](https://www.pro-football-reference-.com/)."""
)
...
# http://www.pro-football-reference.com/years/2019/rushing.htm
@st.cache
def load_data(year):
...
st.markdown(filedownload(df_selected_team), unsfae_allow_html=True)
